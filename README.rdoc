...
=== On Mac:
a. If on a Mac, install Homebrew with
...
3. Fork this repository on the GitHub website, then clone your repository onto your computer:

        git clone git@github.com:[Your Github Account]/caltaiko.git

4. Go into the caltaiko repository

      cd caltaiko

6. Run <tt>which convert</tt> to find out where ImageMagick was installed.
...
8. Download the appropriate gems using Bundler[http://bundler.io/rails3.html]:
