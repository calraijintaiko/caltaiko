...
b. Run the command <tt>brew install imagemagick</tt> to install ImageMagick.
...
c. Run the command <tt>./configure</tt>

d. Once configuration is done, run <tt>make</tt> and then <tt>sudo make install</tt>.
...
7. Enter the command <tt>gem install bundler</tt>

8. Download the appropriate gems using Bundler[http://bundler.io/rails3.html]:

   <tt>bundle install</tt>

9. Create the database by running <tt>rake db:create</tt>, then push all the migrations to it with <tt>rake db:migrate</tt>
