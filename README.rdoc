...
* <b>Build Status:</b> {<img src="https://travis-ci.org/greytoyota/caltaiko.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/greytoyota/caltaiko]
* <b>Code Climate:</b> {<img src="https://codeclimate.com/github/greytoyota/caltaiko/badges/gpa.svg" />}[https://codeclimate.com/github/greytoyota/caltaiko]
...
* {Rails 4.2.0}[http://rubyonrails.org/]

* ImageMagick[http://www.imagemagick.org/]

== Setup:

<b>Note:</b> I've successfully installed this app on Mac and Ubuntu so
far. From what I've discovered so far, Windows only supports up to
Ruby 2.0.0 as of August 2014. That being that case, you could try changing the required
ruby versions in the .ruby-version and Gemfile files, but I have no
...
2. Run the commands
   ...
   to download ruby v2.1.5 and begin using it.
...
d. Add the line
       ...
       export PATH=/Applications/Postgres.app/Contents/Versions/VERSION_NUMBER/bin:$PATH

   to your <tt>~/.bash_profile</tt> file, where VERSION_NUMBER is whatever version of
   Postgres.app you have.
...
d. Install Postgresql with the command
           ...
           sudo apt-get install postgresql psql-dev

e. Give your user account the ablility to create the
   database with the command

        sudo -u postgres createuser --superuser USERNAME

If you are having trouble getting Postgres set up, try following the
instructions provided here[https://help.ubuntu.com/community/PostgreSQL#Installation]
...
5. Download the appropriate gems using Bundler[http://bundler.io]:
...
not being included (it's listed in the gitignore so it shouldn't be, but make ABSOLUTELY
SURE!!!). This is extremely important, since if those access keys wind up on GitHub,
bad people can very easily use them to rack up a bill of several thousand dollars on
your AWS account.
