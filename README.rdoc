...
On July 10th, I got the app up and running on
http://caltaiko.herokuapp.com. In order to do so, however, I made a
number of changes to the inner workings of the app that make it much
harder to run locally. At some point I will update this README to
include instructions on how to do it, but at present, you won't be
able to get it working on your own machine. Sorry!! I'll try to fix
...
6. On Ubuntu, give your user account the ablility to create the database
...
1. Create `config/aws_config.yml`
...
1. Enter the following
    ...
    GMAIL_USERNAME: FULL_EMAIL_ADDRESS
