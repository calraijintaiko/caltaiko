...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { date: @performance.date, description: @performance.description, location: @performance.location, title: @performance.title, upcoming: @performance.upcoming }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { date: @performance.date, description: @performance.description, location: @performance.location, title: @performance.title, upcoming: @performance.upcoming }
    assert_redirected_to performance_path(assigns(:performance))
  end
